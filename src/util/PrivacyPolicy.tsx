  ...
  return (
    <div>
      ...
      <div>
        ...
        <h3>제 1 조 (목적)</h3>
        <p>
          이 약관은 {`{With Buddy}`}에서 제공하는 인터넷서비스(이하 "서비스"라
        ...
        <p>
          ...
          <br />⑤ 해지: 사이트 또는 회원이 서비스 이용계약을 취소하는 것을
          말합니다.
        </p>
        ...
        <p>
          ...
          <br />③ 사이트는 이 약관에서 정한 바에 따라 지속적, 안정적으로
          서비스를 제공할 의무가 있습니다.
        </p>
        ...
        <p>
          ...
          사항을 준수하여야 합니다.
          <br />③ 회원은 내용별로 사이트가 서비스 공지사항에 게시하거나 별도로
        ...
        <p>
          ...
          대하여, 회원은 반드시 사이트에 그 사실을 통보해야 합니다.
        </p>
        ...
        <h3>[부칙]</h3>
        <p>(시행일) 이 약관은 2024년 09월부터 시행합니다.</p>
      </div>
    </div>
  );
};
